...
- **Gemini Quota limits vary heavily by tier (Google AI Studio vs. Vertex AI):**
  *   *Free Tier (Google AI Studio):* Typically allows up to 500 to 1,000 requests per day, capped at 15 RPM (requests per minute) and 250,000 TPM (tokens per minute).
  *   *Pay-As-You-Go / Paid Tier (Vertex AI / Google Cloud):* Allows significantly higher quotas depending on project usage tier. Consumption and upgrades can be monitored directly in the Google AI Studio / Google Cloud console.
